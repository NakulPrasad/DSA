...
Given an integer array `nums` of **unique** elements, return *all possible* <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r4l:" data-state="closed" class=""><em>subsets</em></button> *(the power set)*.
